...
},{"./_stream_duplex":17,"_process":11,"buffer":3,"core-util-is":22,"events":7,"inherits":9,"isarray":10,"process-nextick-args":23,"stream":29,"string_decoder/":39,"util":2}],20:[function(require,module,exports){
...
},{"./_stream_duplex":17,"buffer":3,"core-util-is":22,"events":7,"inherits":9,"process-nextick-args":23,"stream":29,"util-deprecate":24}],22:[function(require,module,exports){
(function (Buffer){
...
},{"./lib/_stream_duplex.js":17,"./lib/_stream_passthrough.js":18,"./lib/_stream_readable.js":19,"./lib/_stream_transform.js":20,"./lib/_stream_writable.js":21,"stream":29}],27:[function(require,module,exports){
...
!function(t){"use strict";var e=require("http"),n=require("https"),i=t.XP||require("expandjs"),s=t.XPEmitter||require("xp-emitter");module.exports=new i.Class("XPRequest",{"extends":s,options:{contentType:null,dataType:null,encoding:null,headers:null,keepAlive:0,method:"GET",path:"",port:null,url:""},initialize:{promise:!0,value:function(e,n){i.assertArgument(i.isObject(e)||i.isString(e,!0),1,"Object or string");var r=this;t.location||{};s.call(r),r.options=i.isString(e)?{}:e,r.contentType=r.options.contentType,r.dataType=r.options.dataType,r.encoding=r.options.encoding,r.headers=r.options.headers||{},r.keepAlive=r.options.keepAlive,r.method=r.options.method,r.url=r.options.url,r.path=r.options.path,r.port=r.options.port,r.secure="https:"===(r.parsed.protocol||t.location&&t.location.protocol),r.resolver=n,r.state="idle",r._chunks=[],r._adapt(),r._adaptee.on("error",r._handleError.bind(r)),r._adaptee.on("response",r._handleResponse.bind(r))}},abort:function(){var t=this;return t.tsAbort?t:(t._adaptee.abort(),t.state="aborted",t.tsAbort=Date.now(),t)},submit:function(t){i.assertArgument(i.isVoid(t)||i.isObject(t)||i.isString(t,!0),1,"Buffer, Object or string");var e=this;return e.tsSubmit?e:("GET"===e.method||i.isString(t)||Buffer.isBuffer(t)||(t=JSON.stringify(t)),e._adaptee.end("GET"!==e.method?t:void 0),e.state="pending",e.tsSubmit=Date.now(),e)},_adapt:{enumerable:!1,value:function(){var i=this,s=t.location||{},r=i.secure?443:80,a=i.secure?n:e;return i._adaptee=a.request({auth:i.parsed.auth,headers:i.headers,hostname:i.parsed.hostname||s.hostname,keepAlive:i.keepAlive>0,keepAliveMsecs:Math.max(i.keepAlive,0),method:i.method,path:i.path||i.parsed.path+(i.parsed.hash||""),protocol:i.secure?"https:":"http:",port:i.port||i.parsed.port||i.parsed.hostname&&r||s.port,withCredentials:!1}),i}},_parse:{enumerable:!0,value:function(t){var e=this;return"json"===e.dataType?JSON.parse(t):t}},contentType:{set:function(t){return this.contentType||t||"auto"},validate:function(t){return i.isString(t,!0)}},data:{validate:function(t){return i.isString(t)||Buffer.isBuffer(t)}},dataType:{set:function(t){return this.dataType||t||"auto"},validate:function(t){return"auto"===t||i.includes(this.dataTypes,t)}},dataTypes:{frozen:!0,writable:!1,value:["json"]},encoding:{set:function(t){return i.isDefined(this.encoding)?this.encoding:t},validate:function(t){return i.isVoid(t)||i.isString(t,!0)}},headers:{set:function(t){return this.headers||i.isObject(t)&&i.cloneDeep(t)},then:function(t){"auto"!==t&&(this.headers["Content-Type"]=t)},validate:function(t){return i.isObject(t)}},keepAlive:{set:function(t){return this.keepAlive>=0?this.keepAlive:t||0},validate:function(t){return i.isInt(t,!0)}},method:{set:function(t){return this.method||i.upperCase(t)||"GET"},validate:function(t){return i.isString(t,!0)}},parsed:{set:function(t){return this.parsed||t},validate:function(t){return i.isObject(t)}},path:{set:function(t){return i.isDefined(this.path)?this.path:!this.url&&t||""},validate:function(t){return i.isString(t)}},port:{set:function(t){return i.isDefined(this.port)?this.port:!this.url&&t||null},validate:function(t){return i.isVoid(t)||i.isFinite(t,!0)}},response:{set:function(t){return this.response||t},validate:function(t){return i.isObject(t)}},secure:{set:function(t){return i.isDefined(this.secure)?this.secure:!!t}},state:{then:function(t){this.emit("state",t,this)},validate:function(t){return i.includes(this.states,t)}},states:{frozen:!0,writable:!1,value:["aborted","failed","idle","pending","received","receiving"]},tsAbort:{set:function(t){return this.tsAbort||t},validate:function(t){return i.isFinite(t,!0)}},tsData:{set:function(t){return this.tsData||t},validate:function(t){return i.isFinite(t,!0)}},tsResponse:{set:function(t){return this.tsResponse||t},validate:function(t){return i.isFinite(t,!0)}},tsSubmit:{set:function(t){return this.tsSubmit||t},validate:function(t){return i.isFinite(t,!0)}},url:{set:function(t){return i.isDefined(this.url)?this.url:t||""},then:function(t){this.parsed=i.parseURL(t)||{}},validate:function(t){return i.isString(t)}},_adaptee:{enumerable:!1,set:function(t){return this.request||t},validate:function(t){return i.isObject(t)}},_chunks:{set:function(t){return this._chunks||t},validate:function(t){return i.isArray(t)}},_handleData:function(t){var e=this;e._chunks.push(t),e.emit("chunk",t,e)},_handleEnd:function(){var t=this;try{t.data=t._parse(Buffer.isBuffer(t._chunks[0])?Buffer.concat(t._chunks):t._chunks.join("")),t.state="received",t.tsData=Date.now()}catch(e){return t._handleError(e.message)}t.resolver(null,t.data),t.emit("data",t.data,t)},_handleError:function(t){var e=this;e.state="failed",e.tsResponse=Date.now(),e.tsData=e.tsResponse,e.resolver(t),e.emit("response",null,e),e.emit("error",t,e)},_handleResponse:function(t){var e=this;e.response=t,e.state="receiving",e.tsResponse=Date.now(),e.encoding&&t.setEncoding(e.encoding),t.on("data",e._handleData.bind(e)),t.on("end",e._handleEnd.bind(e)),e.emit("response",t,e)}})}("undefined"!=typeof window?window:global);
